...
public class ProcessoSteps
{
    ...
    public void o_administrador_informar_o_nome_a_duração_em_dias_e_o_responsavel(String nome, String duracao, String responsavel) throws Throwable
    {
        ...
        BrowserManager.driver.findElement(By.id("j_idt19:j_idt20:value_nome")).sendKeys(nome);
        WebElement duracao_em_dias = BrowserManager.driver.findElement(By.id("j_idt19:j_idt20:value_duracao_input_input"));

        duracao_em_dias.clear();
        duracao_em_dias.sendKeys(duracao);

        WebElement div_responsavel = BrowserManager.driver.findElement(By.id("j_idt19:j_idt20:responsavel_processo"));
...
//        BrowserManager.driver.findElement(By.id("form:tab_view:button_salvar_processo")).click();
    ...
    public void ir_para_a_aba_confirmação_e_salvar() throws Throwable
    {
        ...
        BrowserManager.driver.findElement(By.id("j_idt19:j_idt20:salvar")).click();
    }
    ...
    public void ir_para_aba_de_atividades_e_adicionar_as_seguintes_atividades(DataTable atividades)
    {
        ...
        {
            driver.manage().timeouts().implicitlyWait(2, TimeUnit.SECONDS);
            BrowserManager.driver.findElement(By.id("j_idt19:j_idt20:form_atividades:value_nome_atividade")).sendKeys(atividade_atual.get(0));
            
            WebElement div_departamento = BrowserManager.driver.findElement(By.id("j_idt19:j_idt20:form_atividades:departamento"));
            ...
            BrowserManager.driver.findElement(By.id("j_idt19:j_idt20:form_atividades:button_salvar")).click();
